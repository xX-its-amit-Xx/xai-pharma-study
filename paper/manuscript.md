...
## References
BibTeX in [`paper/references.bib`](references.bib). Key works cited in text: Hooker et al.
2019 (ROAR); Adebayo et al. 2018 (sanity checks); Lundberg & Lee 2017 (SHAP); Ribeiro et al.
2016 (LIME); Sundararajan et al. 2017 (IG); Sanchez-Lengeling et al. 2020; Alvarez-Melis &
Jaakkola 2018; Huang et al. 2021 (TDC); Liu et al. 2023 (M4); Krishna et al. 2022 (Disagreement
Problem); Geifman & El-Yaniv 2017 (selective prediction); Baell & Holloway 2010 (PAINS);
...
extension (§3.9), the external PAINS/BRENK chemistry validation (§3.8), the sufficiency and
shift analyses (§3.7), and the LIME-budget correction (§3.4) were added in response across
review rounds R1–R5. Two items are honestly scoped to camera-ready: multi-seed across all 12
